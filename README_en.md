...
- [Installation](#installation)
  - [MotorStudio GUI](#3-install-motorstudio-gui-optional)
...
pip install -e ".[gui]"       # with MotorStudio GUI support
```
...
The `debugger` extra remains as a compatibility alias, but new environments should use `.[gui]`.
