...
class XboxArmController:
    ...
    def _sync_gripper_feedback(self):
        try:
    ...
    def _handle_gripper_dpad(self, dpad_y: float):
        # Linux joystick convention for common Xbox profiles: D-pad up is -1.
        if dpad_y < -0.5:
            direction = -1  # open
        elif dpad_y > 0.5:
            direction = 1   # close
    ...
    def _nudge_gripper(self, delta: float, *, force: bool = False, log_now: bool = False):
